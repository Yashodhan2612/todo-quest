...
import { LayoutDashboard, CheckSquare, Calendar, Trophy, Plus } from 'lucide-react';
      ...
      >
        <div className="flex items-center gap-3 mb-3">
          ...
          <div className="flex-1 min-w-0">
            <div className="text-sm font-semibold text-white truncate">Level {level}</div>
            <div className="text-xs text-purple-300">{store.game.xp} XP total</div>
          </div>
          {store.game.streak > 0 && (
